...
APK_SHA256="e64bf295c8d24bd437831f74633cb9c162bd149d41cd9fbb9cf3bb2b1c56213c"
...
# build apk-tools
cd /apk-tools-v${APK_VER} || exit 1
rm -rf build && mkdir build && cd build && meson setup .. --prefix=/usr || exit 1
